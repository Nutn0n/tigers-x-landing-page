...
const bundleTh: MissionContent = {
  ...
  storyContent: {
    ...
    paragraphs: [
      "การทดลองเพื่อศึกษาฟิสิกส์ของของไหลในสภาวะไร้น้ำหนัก ผ่านแบบจำลองการให้สารอาหารทางหลอดเลือดดำ (TPN) และศึกษาพฤติกรรมการผสมกันระหว่างน้ำกับน้ำมัน ที่จะนำไปสู่การปรับปรุงและพัฒนาสูตรยาทางการแพทย์ทั้งบนโลกและอวกาศในอนาคต โดยออกแบบและพัฒนาโดยนักวิจัยและวิศวกรไทย เพื่อทำงานบนสถานีอวกาศนานาชาติ",
    ],
  },
  ...
  scienceContent: {
    ...
    subheading: "การศึกษา Total Parenteral Nutrition",
    paragraphs: [
      "การให้สารอาหารทางหลอดเลือดดำ หรือ Total Parenteral Nutrition (TPN) เป็นเทคโนโลยีทางการแพทย์ที่ช่วยชีวิตผู้ป่วยจำนวนมาก โดยเฉพาะผู้ที่ระบบทางเดินอาหารไม่สามารถทำงานได้ตามปกติ เช่น ผู้ป่วยมะเร็ง ผู้ป่วยหลังผ่าตัดใหญ่ หรือผู้ป่วยในภาวะโคม่า แต่ข้อจำกัดสำคัญของ TPN ในปัจจุบันคือ มันยังอาศัยแนวคิดแบบ “การแพทย์แบบเหมารวม” มากกว่า “การแพทย์เฉพาะบุคคล” อย่างแท้จริง",
      "เพราะปัญหาไม่ได้อยู่แค่การเลือกสารอาหารให้เหมาะกับผู้ป่วย แต่อยู่ที่การเข้าใจว่าสารอาหารเหล่านั้นมีพฤติกรรมอย่างไรเมื่ออยู่ร่วมกันในระบบของเหลวหลายสถานะ (Multiphase) โดยเฉพาะระบบอิมัลชัน (Emulsion) ที่มีทั้งไขมัน น้ำ โปรตีน วิตามิน เกลือแร่ และสารชีวโมเลกุลอื่น ๆ ปฏิสัมพันธ์กันตลอดเวลา หากระบบนี้ไม่เสถียร เช่น เกิดการรวมตัวของหยดไขมัน การแยกชั้น หรือการเปลี่ยนแปลงของขนาดอนุภาค ก็อาจกระทบต่อความแม่นยำของปริมาณสารอาหาร ความปลอดภัยของผู้ป่วย และประสิทธิภาพของการรักษาโดยตรง",
    ],
  },
  ...
  microgravityContent: {
    ...
    paragraphs: [
      "ในฟิสิกส์ของของไหลบนโลก แรงโน้มถ่วงเป็นตัวแปรสำคัญที่ครอบงำพฤติกรรมของของไหล ไม่ว่าจะเป็นการแยกชั้น การตกตะกอน หรือการลอยตัว ทำให้สิ่งที่เห็นจากการทดลองอาจไม่ใช่พฤติกรรมแท้ ๆ ของระบบในระดับจุลภาค แต่เป็นผลที่ถูกแรงโน้มถ่วงบดบังหรือขยายให้เด่นขึ้นมา จึงทำให้การศึกษาของไหลที่ซับซ้อนบนโลกมีข้อจำกัด",
    ...
    cards: [
      {
        title: "เฟส 1 / เที่ยวบินระยะสั้นในสภาวะไร้น้ำหนัก",
      ...
      {
        title: "เฟส 2 / การทดลองระยะยาวบนสถานีอวกาศนานาชาติ",
  ...
  systemDesignContent: {
    eyebrow: "บทที่ 04 / ผลกระทบต่ออุสาหกรรมอาหารและยา",
    ...
    impacts: [
      ...
      },
      {
        ...
        body: "ความรู้นี้ช่วยออกแบบระบบอาหารและของไหลสำหรับภารกิจอวกาศระยะยาว ในอวกาศสูตรต้องคงตัวตลอดเวลา ไม่แยกชั้น เก็บรักษาได้โดยไม่มีแรงโน้มถ่วง เป็นหนึ่งในสิ่งที่ทำให้ระบบอาหารสามารถทำงานได้อย่างถูกต้องในสภาวะไร้น้ำหนัก",
      },
      {
        term: "ระยะยาว",
  ...
  networkContent: {
    ...
    heading: "ติดต่อและสังการโดยตรงไปยังสถานีอวกาศนานาชาติ",
    paragraphs: [
      "ทีมวิจัยสามารถสื่อสารกับโพย์โหลดผ่านเครือข่าย TCP/IP บนสถานีอวกาศนานาชาติผ่านสถานีภาคพื้นดินของ Space Applications Services ที่ประเทศเบลเยียม และเชื่อมต่อกับทีมควบคุมภารกิจในกรุงเทพฯ",
      "ทีมสามารถรับส่งคำสั่งไปยังสถานีอวกาศนานาชาติได้ใกล้เคียงเรียลไทม์",
    ],
  ...
  specContent: {
    ...
    specs: [
      { key: "ขนาด", value: "200 × 200 × 100", unit: "มม." },
  ...
  timelineContent: {
    ...
    intro:
      "จากการเข้าร่วมโครงการ NASA Space Food Challenge สู่การทำการทดลองจริงบนสถานีอวกาศนานาชาติ",
    railStatus: "สถานะ",
    railOnTrack: "เป็นไปตามแผน",
  ...
  closingContent: {
    ...
    footer: {
      ...
      designCredit: "ออกแบบโดยณัฐนนท์ ดวงสูงเนิน",
      copyrightNotice: "TIGERS-X All rights reserved.",
