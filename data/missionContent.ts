...
const bundleTh: MissionContent = {
  ...
  scienceContent: {
    ...
    paragraphs: [
      "การให้สารอาหารทางหลอดเลือดดำ (TPN) เป็นทางเลือกที่ช่วยชีวิตผู้ป่วยที่ใช้ระบบทางเดินอาหารไม่ได้ แต่ในทางปฏิบัติยังพึ่งพาแนวทาง “การแพทย์แบบเหมารวม” (One-Size-Fits-All Medicine) มากกว่าการแพทย์เฉพาะบุคคลที่แท้จริง ซึ่งข้อจำกัดไม่ได้อยู่ที่การเลือกสารอาหารเพียงอย่างเดียว แต่อยู่ที่การเข้าใจว่าระบบเหล่านั้นประพฤติตัวอย่างไรในฐานะระบบที่ซับซ้อน",
      "ฟิสิกส์สำคัญของเรื่องดังกล่าวคือ การผสมกันระหว่างของเหลวที่ต่างเฟสกัน (น้ำ ไขมัน และโมเลกุลชีวภาพ) เรียกว่ากระบวนการ Emulsion ซึ่งทำให้ของเหลวที่ปกติไม่เข้ากันสามารถกระจายตัวอย่างเสถีย ปัจจุบันนักวิทยาศาสตร์พยายามทำความเข้าใจฟิสิกส์ที่ควบคุมกระบวนการนี้เพื่อนำไปสู่โมเดลที่อธิบายพฤติรรมของมัน อันเป็นหัวใจสำคัญของการแพทย์ และอุตสาหกรรมอาหารและยา",
    ],
  },
  ...
  microgravityContent: {
    ...
    paragraphs: [
      "ในการทำความเข้าใจฟิสิกส์ของของไหลบนโลก แรงโน้มถ่วงคือตัวแปรสำคัญที่นำไปสู่ความจำเพาะ ทำให้เกิดการตกตะกอน การแยกตัวตามความถ่วงจุด และการพาความร้อน ซึ่งบดบังพฤติกรรมในระดับจุลภาคที่ถูกควบคุมโดยแรงตึงผิวและการแพร่",
      "สภาวะไร้น้ำหนักบนสถานีอวกาศนานาชาติทำหน้าที่เหมือน “สนามทดลองฟิสิกส์” ให้เราแยกกลไกพื้นฐานของฟิสิกส์ของไหลได้ชัดเจนขึ้น เพื่อเกตปรากฏการณ์ที่เข้าถึงได้ยากบนโลก",
    ],
    cards: [
      {
